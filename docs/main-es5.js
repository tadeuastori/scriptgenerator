                ...
                if (Boolean(item.value["name"]) &&
                    ...
                    if (Boolean(item.value["blockpage"]) && Boolean(item.value["url"])) {
                        if (!Boolean(queryAlternativeValue)) {
                            queryAlternativeValue = "\t /*Cria queries para aplicar em outros clientes*/\n";
                        }
