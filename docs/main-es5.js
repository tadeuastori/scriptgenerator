...
module.exports = "<div class=\"modal fade bd-example-modal-xl\" id=\"scriptGenerateModal\" tabindex=\"-1\" role=\"dialog\"\n    aria-labelledby=\"exampleModalScrollableTitle\" aria-hidden=\"true\">\n    <div class=\"modal-dialog modal-dialog-scrollable modal-xl\" role=\"document\">\n        <div class=\"modal-content bg-info\">\n\n            <div class=\"modal-header\">\n                <h5 class=\"modal-title text-white\" id=\"exampleModalScrollableTitle\">{{pageTitleModal}}'s Script</h5>\n                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                    <span aria-hidden=\"true\">&times;</span>\n                </button>\n            </div>\n\n            <div class=\"modal-body\" style=\"background-color: #E9ECEF;\">\n                <ul class=\"nav nav-pills\" id=\"myTab\" role=\"tablist\"\n                    *ngIf=\"enableAba\">\n                    <li class=\"nav-item\">\n                        <a class=\"nav-link active\" id=\"home-tab\" data-toggle=\"tab\" href=\"#home\" role=\"tab\"\n                            (click)=\"changeNavs(1)\" aria-controls=\"home\" aria-selected=\"true\">Script Generated</a>\n                    </li>\n                    <li class=\"nav-item\">\n                        <a class=\"nav-link\" id=\"alternative-tab\" data-toggle=\"tab\" href=\"#alternative\" role=\"tab\"\n                            (click)=\"changeNavs(2)\" aria-controls=\"alternative\" aria-selected=\"false\">Alternative Script\n                            Generated</a>\n                    </li>\n                </ul>\n\n                <div class=\"tab-content\" id=\"myTabContent\">\n                    <div class=\"tab-pane fade show active\" id=\"home\" role=\"tabpanel\" aria-labelledby=\"home-tab\">\n                        <div id=\"divConteudoGenerated\" style=\"text-align: center; \">\n                            <textarea type=\"text\" id=\"generatedScript\" [(ngModel)]=\"generatedScript\" class=\"scriptarea\"\n                                disabled (ngModelChange)=\"cleanMessage();\"></textarea>\n                            <br>\n                            &nbsp;&nbsp;<span class=\"badge badge-success\">{{copyMessage}}</span>&nbsp;&nbsp;\n                        </div>\n                    </div>\n                    <div class=\"tab-pane fade\" id=\"alternative\" role=\"tabpanel\" aria-labelledby=\"alternative-tab\">\n                        <div id=\"divConteudoAlternativo\"\n                            style=\"text-align: center; background-color: #E9ECEF;\">\n                            <textarea type=\"text\" id=\"alternativeGeneratedScript\"\n                                [(ngModel)]=\"alternativeGeneratedScript\" class=\"scriptarea\" disabled\n                                (ngModelChange)=\"cleanMessage();\"></textarea>\n                            <br>\n                            &nbsp;&nbsp;<span class=\"badge badge-success\">{{copyMessage}}</span>&nbsp;&nbsp;\n                        </div>\n                    </div>\n                </div>\n            </div>\n\n            <div class=\"modal-footer\">\n                <div class=\"container\">\n                    <div class=\"row\">\n                        <div class=\"col\">\n                        </div>\n                        <div class=\"col text-right popupControlBox\">\n                            <button type=\"button\" class=\"btn btn-warning\" (click)=\"copyGeneratedScript()\"\n                                [disabled]=\"enableBtn\">\n                                <img alt=\"Copy Script\" title=\"Copy Script\" src=\"./assets/btn/btnCopy.png\" />\n                                Copy\n                            </button>\n                            <button type=\"button\" class=\"btn btn-success\" (click)=\"dynamicDownloadTxt()\"\n                                [disabled]=\"enableBtn\" *ngIf=\"!isMobileDevice\">\n                                <img alt=\"Download Script\" title=\"Download Script\" src=\"./assets/btn/btnDownload.png\" />\n                                Download\n                            </button>\n                        </div>\n                    </div>\n                </div>\n            </div>\n\n        </div>\n    </div>\n</div>"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.cdrMethod = function () {
        this.checkDevice();
        this.cdr.detectChanges();
    };
    AppComponent.prototype.checkDevice = function () {
...
var ConstantComponent = /** @class */ (function () {
    function ConstantComponent(appcomponent, generatorservice, constantservice, fb, renderer2, _document) {
    ...
    ConstantComponent.prototype.ngOnInit = function () {
    ...
    //#########################################################################################
    ConstantComponent.prototype.createConstantKey = function () {
    ...
    ConstantComponent.prototype.addConstant = function () {
        this.constantList.push(this.createConstantKey());
        this.generateScript();
    };
    ConstantComponent.prototype.removeConstant = function (index) {
        if (confirm("Are you sure to delete this " + this.generatorList.name + "?")) {
            this.constantList.removeAt(index);
            this.generateScript();
        }
    };
    ConstantComponent.prototype.getConstantFormGroup = function (index) {
        var formGroup = this.constantList.controls[index];
        return formGroup;
    };
    Object.defineProperty(ConstantComponent.prototype, "constantFormGroup", {
        get: function () {
    ...
    //#########################################################################################
    ConstantComponent.prototype.generateScript = function () {
        this.constantservice.generateScript(this.form, this.constantList);
    };
    ConstantComponent.ctorParameters = function () { return [
...
var ConstantService = /** @class */ (function () {
    function ConstantService(scriptservice) {
        this.scriptservice = scriptservice;
    }
    ConstantService.prototype.generateScript = function (form, constantList) {
        var e_1, _a;
        var declareSession = "";
        var querySelect = "";
        ...
        var strAux = "";
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](constantList.controls), _c = _b.next(); !_c.done; _c = _b.next()) {
                var item = _c.value;
    ...
    ConstantService.prototype.cleanScript = function () {
        this.scriptservice.cleanScript();
    };
    ConstantService.prototype.returnBlockException = function (script) {
        var query = "";
        if (Boolean(script)) {
            query += "\t begin\n";
            query += "\n";
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(appcomponent, generatorservice) {
        this.appcomponent = appcomponent;
        this.generatorservice = generatorservice;
    }
    ...
    DashboardComponent.prototype.getGeneratorList = function () {
        var _this = this;
        this.generatorservice.getGenerators()
            .subscribe(function (generator) { return _this.generatorList = generator; });
    };
    DashboardComponent.prototype.getStatus = function (version) {
        var retorno;
    ...
    DashboardComponent.prototype.showVersion = function (modify) {
...
var EditcubeComponent = /** @class */ (function () {
    function EditcubeComponent(appcomponent, generatorservice, editcubeService, fb, renderer2, _document) {
        this.appcomponent = appcomponent;
        this.generatorservice = generatorservice;
    ...
    EditcubeComponent.prototype.ngOnInit = function () {
        this.appcomponent.pageTitle = this.generatorList.name;
        this.appcomponent.showCard = true;
    ...
    //#########################################################################################
    EditcubeComponent.prototype.createColumnKey = function () {
        return this.fb.group({
    ...
    EditcubeComponent.prototype.addColumn = function () {
        this.columnList.push(this.createColumnKey());
        this.generateScript();
    };
    EditcubeComponent.prototype.removeColumn = function (index) {
        if (confirm("Are you sure to delete this column?")) {
            this.columnList.removeAt(index);
            this.generateScript();
        }
    };
    EditcubeComponent.prototype.getColumnFormGroup = function (index) {
        var formGroup = this.columnList.controls[index];
        return formGroup;
    };
    Object.defineProperty(EditcubeComponent.prototype, "columnFormGroup", {
        get: function () {
    ...
    //#########################################################################################
    EditcubeComponent.prototype.generateScript = function () {
        this.editcubeService.generateScript(this.form, this.columnList);
    };
    EditcubeComponent.ctorParameters = function () { return [
        { type: _app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"] },
        { type: _generator_service__WEBPACK_IMPORTED_MODULE_3__["GeneratorService"] },
...
var EditcubeService = /** @class */ (function () {
    function EditcubeService(scriptservice) {
        this.scriptservice = scriptservice;
    }
    EditcubeService.prototype.generateScript = function (form, columnList) {
        var e_1, _a;
        var query = "";
        var isCreated = "N";
        var queryProcedure = "";
        ...
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](columnList.controls), _c = _b.next(); !_c.done; _c = _b.next()) {
                var item = _c.value;
    ...
    EditcubeService.prototype.cleanScript = function () {
        this.scriptservice.cleanScript();
    };
    EditcubeService.ctorParameters = function () { return [
        { type: _script_service__WEBPACK_IMPORTED_MODULE_2__["ScriptService"] }
    ]; };
...
var ExportService = /** @class */ (function () {
    ...
    ExportService.prototype.cleanMessage = function () {
        return '';
    };
    ExportService.prototype.setMessageCopyClipBoard = function () {
        return 'Script has been copied to Clipboard';
    };
    ExportService.prototype.setAlternativeMessageCopyClipBoard = function () {
        return 'Alternative script has been copied to Clipboard';
    };
    ExportService.prototype.setMessageDownload = function () {
        return 'The script is ready for download';
    };
    ExportService.prototype.setAlternativeMessageDownload = function () {
        return 'The alternative script is ready for download';
    };
    ExportService.prototype.copyGeneratedScript = function (value, div, aba) {
    ...
    ExportService.prototype.generateFileName = function () {
    ...
    ExportService.prototype.fakeValidateUserData = function (value) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(value);
    };
    ExportService.prototype.dynamicDownloadTxt = function (value) {
        var _this = this;
        this.fakeValidateUserData(value).subscribe(function (res) {
            _this.dyanmicDownloadByHtmlTag({
                fileName: 'delta-' + _this.generateFileName() + '.sql',
                text: res
            });
        });
    };
    ExportService.prototype.dyanmicDownloadByHtmlTag = function (arg) {
...
var FunctioncontrolComponent = /** @class */ (function () {
    function FunctioncontrolComponent(appcomponent, generatorservice, functioncontrolservice, fb, renderer2, _document) {
        this.appcomponent = appcomponent;
        this.generatorservice = generatorservice;
    ...
    FunctioncontrolComponent.prototype.ngOnInit = function () {
        this.appcomponent.pageTitle = this.generatorList.name;
        this.appcomponent.showCard = true;
    ...
    //#########################################################################################
    FunctioncontrolComponent.prototype.createFunctionControl = function () {
        return this.fb.group({
    ...
    FunctioncontrolComponent.prototype.addFunctionControl = function () {
        this.functioncontrolList.push(this.createFunctionControl());
        this.generateScript();
    };
    FunctioncontrolComponent.prototype.removeFunctionControl = function (index) {
        if (confirm("Are you sure to delete this " + this.generatorList.name + "?")) {
            this.functioncontrolList.removeAt(index);
            this.generateScript();
        }
    };
    FunctioncontrolComponent.prototype.getFunctionControlFormGroup = function (index) {
        var formGroup = this.functioncontrolList.controls[index];
        return formGroup;
    };
    Object.defineProperty(FunctioncontrolComponent.prototype, "functionControlFormGroup", {
        get: function () {
    ...
    //#########################################################################################
    FunctioncontrolComponent.prototype.generateScript = function () {
        this.functioncontrolservice.generateScript(this.form, this.functioncontrolList);
    };
    FunctioncontrolComponent.ctorParameters = function () { return [
        { type: _app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"] },
        { type: _generator_service__WEBPACK_IMPORTED_MODULE_3__["GeneratorService"] },
    ...
    return FunctioncontrolComponent;
}());
...
var FunctioncontrolService = /** @class */ (function () {
    function FunctioncontrolService(scriptservice) {
        this.scriptservice = scriptservice;
    }
    FunctioncontrolService.prototype.generateScript = function (form, functioncontrolList) {
        var e_1, _a;
        var declareSession = "";
        var queryProcedure = "";
        var queryProcess = "";
        ...
        query += "Begin\n\n";
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](functioncontrolList.controls), _c = _b.next(); !_c.done; _c = _b.next()) {
                var item = _c.value;
    ...
    FunctioncontrolService.prototype.cleanScript = function () {
        this.scriptservice.cleanScript();
    };
    FunctioncontrolService.ctorParameters = function () { return [
        { type: _script_service__WEBPACK_IMPORTED_MODULE_2__["ScriptService"] }
    ]; };
...
var GeneratorService = /** @class */ (function () {
    ...
    // }
    GeneratorService.prototype.getGenerator = function (component) {
        var e_1, _a;
        try {
            for (var GENERATORS_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](_dashboard_mock_generators__WEBPACK_IMPORTED_MODULE_2__["GENERATORS"]), GENERATORS_1_1 = GENERATORS_1.next(); !GENERATORS_1_1.done; GENERATORS_1_1 = GENERATORS_1.next()) {
                var item = GENERATORS_1_1.value;
...
module.exports = " .scriptarea{\r\n    width: 100%;\r\n    height: 450px;\r\n    resize: none;\r\n    background-color: #ffffff;\r\n}\r\n\r\n.popupControlBox{\r\n    align-self: center;\r\n}\r\n\r\n.popupControlBox button{\r\n    margin: 0px 5px;\r\n}\r\n\r\n.nav-link{\r\n    color: black;\r\n    background-color: #ffffff;\r\n    margin-right: 4px;\r\n    margin-bottom: 2px;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ModalscriptComponent = /** @class */ (function () {
    function ModalscriptComponent(appcomponent, scriptservice, exportService) {
        var _this = this;
        this.appcomponent = appcomponent;
        this.scriptservice = scriptservice;
        ...
        this.alternativeGeneratedScript = '';
        this.copyMessage = '';
        this.isMobileDevice = this.appcomponent.isMobileDevice;
        this.enableBtn = true;
        this.navActive = "1";
        this.enableAba = false;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["interval"])(500).subscribe(function (x) { _this.openScript(), _this.checkAba(), _this.enableBtn = !Boolean(_this.generatedScript); });
        Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["interval"])(7000).subscribe(function (y) { _this.checkMessage(); });
    }
    ModalscriptComponent.prototype.ngOnInit = function () {
        this.pageTitleModal = this.appcomponent.pageTitle;
    };
    ModalscriptComponent.prototype.openScript = function () {
        this.generatedScript = this.scriptservice.GetScript();
        this.alternativeGeneratedScript = this.scriptservice.GetAlternativeScript();
    };
    //######################
    ModalscriptComponent.prototype.copyGeneratedScript = function () {
        if (this.navActive == "1") {
    ...
    ModalscriptComponent.prototype.cleanMessage = function () {
    ...
    ModalscriptComponent.prototype.dynamicDownloadTxt = function () {
        if (this.navActive == "1") {
    ...
    ModalscriptComponent.prototype.changeNavs = function (value) {
        this.copyMessage = this.exportService.cleanMessage();
        this.navActive = value;
    };
    //######################
    ModalscriptComponent.prototype.checkMessage = function () {
        if (Boolean(this.copyMessage)) {
            this.copyMessage = this.exportService.cleanMessage();
        }
    };
    ModalscriptComponent.prototype.checkAba = function () {
        this.enableAba = Boolean(this.alternativeGeneratedScript);
    };
    ModalscriptComponent.ctorParameters = function () { return [
        { type: _app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"] },
...
var NewcubeComponent = /** @class */ (function () {
    function NewcubeComponent(appcomponent, generatorservice, newcubeService, fb, renderer2, _document) {
        this.appcomponent = appcomponent;
        this.generatorservice = generatorservice;
    ...
    NewcubeComponent.prototype.ngOnInit = function () {
        this.appcomponent.pageTitle = this.generatorList.name;
        this.appcomponent.showCard = true;
    ...
    //#########################################################################################
    NewcubeComponent.prototype.createColumnKey = function () {
        return this.fb.group({
            columnname: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required])],
            format: ['TX'],
            portuguese: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required])],
    ...
    NewcubeComponent.prototype.addColumn = function () {
        this.columnList.push(this.createColumnKey());
        this.generateScript();
    };
    NewcubeComponent.prototype.removeColumn = function (index) {
        if (confirm("Are you sure to delete this column?")) {
            this.columnList.removeAt(index);
            this.generateScript();
        }
    };
    NewcubeComponent.prototype.getColumnFormGroup = function (index) {
        var formGroup = this.columnList.controls[index];
        return formGroup;
    };
    Object.defineProperty(NewcubeComponent.prototype, "columnFormGroup", {
        get: function () {
            return this.form.get('column');
        },
        enumerable: true,
    ...
    //#########################################################################################
    NewcubeComponent.prototype.generateScript = function () {
        this.newcubeService.generateScript(this.form, this.columnList);
    };
    NewcubeComponent.ctorParameters = function () { return [
        { type: _app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"] },
        { type: _generator_service__WEBPACK_IMPORTED_MODULE_3__["GeneratorService"] },
...
var NewcubeService = /** @class */ (function () {
    function NewcubeService(scriptservice) {
        this.scriptservice = scriptservice;
    }
    NewcubeService.prototype.generateScript = function (form, columnList) {
        var e_1, _a;
        var query = "";
        var isCreated = "N";
        var queryProcedure = "";
    ...
    NewcubeService.prototype.cleanScript = function () {
        this.scriptservice.cleanScript();
    };
    NewcubeService.ctorParameters = function () { return [
        { type: _script_service__WEBPACK_IMPORTED_MODULE_2__["ScriptService"] }
    ]; };
...
var PageComponent = /** @class */ (function () {
    function PageComponent(appcomponent, generatorservice, pageservice, fb, renderer2, _document) {
        this.appcomponent = appcomponent;
        this.generatorservice = generatorservice;
    ...
    //#########################################################################################
    PageComponent.prototype.createPage = function () {
        return this.fb.group({
    ...
    PageComponent.prototype.addPage = function () {
        this.pageList.push(this.createPage());
        this.generateScript();
    };
    PageComponent.prototype.removePage = function (index) {
        if (confirm("Are you sure to delete this " + this.generatorList.name + "?")) {
            this.pageList.removeAt(index);
            this.generateScript();
        }
    };
    PageComponent.prototype.getPageFormGroup = function (index) {
        var formGroup = this.pageList.controls[index];
        return formGroup;
    };
    Object.defineProperty(PageComponent.prototype, "pageFormGroup", {
        get: function () {
    ...
    //#########################################################################################
    PageComponent.prototype.generateScript = function () {
...
var PageService = /** @class */ (function () {
    function PageService(scriptservice) {
        this.scriptservice = scriptservice;
    }
    PageService.prototype.generateScript = function (form, pageList) {
        var e_1, _a;
        var languages = ['pt-BR', 'pt-PT', 'en-US', 'en-GB', 'es-UY', 'zh-CN'];
        var query = "";
        var isCreated = "N";
        var queryProcedure = "";
        var queryCheck = "";
        ...
        query += "Begin\n\n";
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](pageList.controls), _c = _b.next(); !_c.done; _c = _b.next()) {
                var item = _c.value;
                if (Boolean(item.value["name"]) &&
                    Boolean(item.value["abbrev"]) &&
                    Boolean(item.value["portuguese"]) &&
                    ...
                    if (Boolean(item.value["blockpage"]) && Boolean(item.value["url"])) {
                        if (!Boolean(queryAlternativeValue)) {
                            queryAlternativeValue = "\t\t /*Create a script to unblock the page*/\n";
                        }
    ...
    PageService.prototype.cleanScript = function () {
        this.scriptservice.cleanScript();
    };
    PageService.prototype.createScriptPageStatus = function (flagBlock, url, name) {
        var query = "";
...
var ParameterComponent = /** @class */ (function () {
    function ParameterComponent(appcomponent, generatorservice, parameterservice, fb, renderer2, _document) {
        this.appcomponent = appcomponent;
        this.generatorservice = generatorservice;
    ...
    //#########################################################################################
    ParameterComponent.prototype.createParameter = function () {
        return this.fb.group({
    ...
    ParameterComponent.prototype.addParameter = function () {
        this.parameterList.push(this.createParameter());
        this.generateScript();
    };
    ParameterComponent.prototype.removeParameter = function (index) {
        if (confirm("Are you sure to delete this " + this.generatorList.name + "?")) {
            this.parameterList.removeAt(index);
            this.generateScript();
        }
    };
    ParameterComponent.prototype.getParameterFormGroup = function (index) {
        var formGroup = this.parameterList.controls[index];
        return formGroup;
    };
    Object.defineProperty(ParameterComponent.prototype, "parameterFormGroup", {
        get: function () {
    ...
    //#########################################################################################
    ParameterComponent.prototype.generateScript = function () {
...
var ParameterService = /** @class */ (function () {
    function ParameterService(scriptservice) {
        this.scriptservice = scriptservice;
    }
    ParameterService.prototype.generateScript = function (form, translateList) {
        var e_1, _a;
        ...
        query += "Begin\n\n";
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](translateList.controls), _c = _b.next(); !_c.done; _c = _b.next()) {
                var item = _c.value;
                if (Boolean(item.value["parameter"]) &&
                    ...
                    if (Boolean(item.value["alternativevalue"])) {
                        if (!Boolean(queryAlternativeValue)) {
                            queryAlternativeValue = "\t /*Cria queries para aplicar em outros clientes (Caso necessário valores segregados)*/\n";
                        }
    ...
    ParameterService.prototype.cleanScript = function () {
        this.scriptservice.cleanScript();
    };
...
var ScriptService = /** @class */ (function () {
    ...
    ScriptService.prototype.GetScript = function () {
        return this.script;
    };
    ScriptService.prototype.GetAlternativeScript = function () {
        return this.alternativeScript;
    };
    ScriptService.prototype.setScript = function (value) {
        this.script = value;
    };
    ScriptService.prototype.setAlternativeScript = function (value) {
        this.alternativeScript = value;
    };
    ScriptService.prototype.cleanScript = function () {
        this.script = '';
        this.alternativeScript = '';
    };
...
module.exports = ".keyArea{\r\n    width: 100%;\r\n    height: 500px;\r\n    resize: none;\r\n    background-color: #ffffff;\r\n}\r\n\r\n\r\n::-webkit-input-placeholder { /* Edge */\r\n    font-style: italic;\r\n  }\r\n\r\n\r\n::-moz-placeholder {\r\n    font-style: italic;\r\n  }\r\n\r\n\r\n::-ms-input-placeholder {\r\n    font-style: italic;\r\n  }\r\n\r\n\r\n::placeholder {\r\n    font-style: italic;\r\n  }\r\n  \r\n\r\n\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var TranslatorComponent = /** @class */ (function () {
    function TranslatorComponent(appcomponent, generatorservice, translatorservice, fb, renderer2, _document) {
        this.appcomponent = appcomponent;
        this.generatorservice = generatorservice;
    ...
    //#########################################################################################
    TranslatorComponent.prototype.createTranslateKey = function () {
        return this.fb.group({
    ...
    Object.defineProperty(TranslatorComponent.prototype, "translateFormGroup", {
    ...
    TranslatorComponent.prototype.addTranslatorKey = function () {
        this.translateList.push(this.createTranslateKey());
        this.generateScript();
    };
    TranslatorComponent.prototype.removeTranslateKey = function (index) {
        if (confirm("Are you sure to delete this " + this.generatorList.name + "?")) {
            this.translateList.removeAt(index);
            this.generateScript();
        }
    };
    TranslatorComponent.prototype.getTranslateFormGroup = function (index) {
        var formGroup = this.translateList.controls[index];
        return formGroup;
    };
    TranslatorComponent.prototype.addMultiKeys = function () {
        var e_1, _a;
        var countLoop = 0;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.translateList.controls), _c = _b.next(); !_c.done; _c = _b.next()) {
                var item = _c.value;
        ...
        var key;
        var arrayKey = this.pasteKeyScript.split("\n");
        for (var index in arrayKey) {
            var arrayField = arrayKey[index].split(";");
            if (Boolean(arrayKey[index])) {
                key = this.fb.group({
                    key: [(Boolean(arrayField[0]) ? arrayField[0] : null), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required])],
                    force: [true, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required])],
                    portuguese: [(Boolean(arrayField[1]) ? arrayField[1] : null), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required])],
                    english: [(Boolean(arrayField[2]) ? arrayField[2] : null), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required])],
                    spanish: [(Boolean(arrayField[3]) ? arrayField[3] : null), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required])]
                });
    ...
    //#########################################################################################
    TranslatorComponent.prototype.generateScript = function () {
        this.translatorservice.generateScript(this.form, this.translateList);
    };
    TranslatorComponent.prototype.switchScript = function () {
    ...
    TranslatorComponent.prototype.checkTypeScript = function (index) {
...
var TranslatorService = /** @class */ (function () {
    function TranslatorService(scriptservice) {
        this.scriptservice = scriptservice;
    }
    ...
    /*###################################################################################*/
    TranslatorService.prototype.createTranslate = function (fb) {
        return fb.group({
    ...
    TranslatorService.ctorParameters = function () { return [
