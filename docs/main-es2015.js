...
let ModalscriptComponent = class ModalscriptComponent {
    constructor(appcomponent, scriptservice, exportService) {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["interval"])(500).subscribe(x => { this.openScript(), this.checkAba(), this.enableBtn = !Boolean(this.generatedScript); });
...
let PageService = class PageService {
    ...
    createScriptPageStatus(flagBlock, url, name) {
        var query = "";
...
let ScriptService = class ScriptService {
    ...
    GetAlternativeScript() {
        return this.alternativeScript;
    }
    setScript(value) {
        this.script = value;
    }
    setAlternativeScript(value) {
